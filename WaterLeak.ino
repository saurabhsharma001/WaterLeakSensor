...
DataToMaker event(myKey, "WaterLeak_Bathroom_3");
...
void setup() {
  ...
  WiFi.config(IPAddress(192, 168, 86, 30), IPAddress(192, 168, 86, 1), IPAddress(255, 255, 255, 0));
...
void loop() {
  ...
  //int chartValue = (analogValue * 200) / 2000;
  int chartValue = map(analogValue, 450, 950, 100, 0);
